...
# Convertir 'Num' a tipo numérico (puedes usar .astype(int) o .astype(float) según necesites)
...
submission_df.to_csv('data/submission_xgboost.csv', index=False)
print("Archivo de envío creado correctamente para XGBoost.")
